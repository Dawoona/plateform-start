...
<title>safer-buffer [![travis][travis-image]][travis-url] [![npm][npm-image]][npm-url] [![javascript style guide][standard-image]][standard-url] [![Security Responsible Disclosure][secuirty-image]][secuirty-url] | Selection M</title>
...
<link rel="canonical" href="http://localhost:4000/node_modules/safer-buffer/" />
<meta property="og:url" content="http://localhost:4000/node_modules/safer-buffer/" />
...
{"@context":"https://schema.org","@type":"WebPage","author":{"@type":"Person","name":"Mathieu Lebreton"},"dateModified":"2023-02-25T16:57:11+01:00","description":"Selection M est une plateforme proposant du contenu créatif sur des domaines tels que le graphisme et la tech. Cette plateforme a pour but de centraliser et diffuser l’ensemble des travaux professionnels et personnels de Mathieu Lebreton, graphiste 360 indépendant à Paris.","headline":"safer-buffer [![travis][travis-image]][travis-url] [![npm][npm-image]][npm-url] [![javascript style guide][standard-image]][standard-url] [![Security Responsible Disclosure][secuirty-image]][secuirty-url]","publisher":{"@type":"Organization","logo":{"@type":"ImageObject","url":"http://localhost:4000/assets/img/selection-m.png"},"name":"Mathieu Lebreton"},"url":"http://localhost:4000/node_modules/safer-buffer/"}</script>
<!-- End Jekyll SEO tag -->
...
<link rel="alternate" href="http://localhost:4000/node_modules/safer-buffer/" hreflang="fr">
...
>
  ...
  <header>
    <h1 class="page-title">safer-buffer [![travis][travis-image]][travis-url] [![npm][npm-image]][npm-url] [![javascript style guide][standard-image]][standard-url] [![Security Responsible Disclosure][secuirty-image]][secuirty-url]</h1>
