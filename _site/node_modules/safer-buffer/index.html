...
{"author":{"@type":"Person","name":"Mathieu Lebreton"},"@type":"WebPage","description":"Découvrez Selection M, une plateforme privée proposant des contenus créatifs sur des domaines tels que le graphisme et le multimédia etc.","headline":"safer-buffer [![travis][travis-image]][travis-url] [![npm][npm-image]][npm-url] [![javascript style guide][standard-image]][standard-url] [![Security Responsible Disclosure][secuirty-image]][secuirty-url]","dateModified":"2023-02-25T16:57:11+01:00","url":"http://localhost:4000/node_modules/safer-buffer/","publisher":{"@type":"Organization","logo":{"@type":"ImageObject","url":"http://localhost:4000/assets/img/selection-m.png"},"name":"Mathieu Lebreton"},"@context":"https://schema.org"}</script>
<!-- End Jekyll SEO tag -->
