...
<title>safer-buffer [![travis][travis-image]][travis-url] [![npm][npm-image]][npm-url] [![javascript style guide][standard-image]][standard-url] [![Security Responsible Disclosure][secuirty-image]][secuirty-url] | Mathieu L.</title>
...
{"@context":"https://schema.org","@type":"WebPage","author":{"@type":"Person","name":"Mathieu Lebreton"},"dateModified":"2023-10-18T21:22:40+02:00","description":"En tant que designer pluridisciplinaire, j’allie technique et design pour créer des projets de qualité. Mes compétences couvrent le design d’expérience, le web design, l’intégration, la 3D, le motion et le print, ainsi que le dessin. J’ai à cœur de collaborer avec engagement, que ce soit des entreprises leaders, ou des agences à taille humaine spécialisées ou des indépendants/solopreneurs.","headline":"safer-buffer [![travis][travis-image]][travis-url] [![npm][npm-image]][npm-url] [![javascript style guide][standard-image]][standard-url] [![Security Responsible Disclosure][secuirty-image]][secuirty-url]","publisher":{"@type":"Organization","logo":{"@type":"ImageObject","url":"http://localhost:4000/assets/img/logo-m.png"},"name":"Mathieu Lebreton"},"url":"http://localhost:4000/node_modules/safer-buffer/"}</script>
<!-- End Jekyll SEO tag -->
