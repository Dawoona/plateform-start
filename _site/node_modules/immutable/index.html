...
<title>Immutable collections for JavaScript | Selection M</title>
...
<link rel="canonical" href="http://localhost:4000/node_modules/immutable/" />
...
<meta property="twitter:title" content="Immutable collections for JavaScript" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","author":{"@type":"Person","name":"Mathieu Lebreton"},"dateModified":"2023-10-18T21:22:40+02:00","description":"Selection M est une plateforme privée de Mathieu Lebreton, graphiste multimédia franco-coréen basé à Paris, diffusant du contenu professionnel et personnel créatif et technique dans le domaine du graphisme, le web et la tech.","headline":"Immutable collections for JavaScript","publisher":{"@type":"Organization","logo":{"@type":"ImageObject","url":"http://localhost:4000/assets/img/selection-m.png"},"name":"Mathieu Lebreton"},"url":"http://localhost:4000/node_modules/immutable/"}</script>
<!-- End Jekyll SEO tag -->
...
<link rel="alternate" href="http://localhost:4000/node_modules/immutable/" hreflang="fr">
...
>
  ...
  <header>
    <h1 class="page-title">Immutable collections for JavaScript</h1>
...
<div class="language-shell highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c"># using npm</span>
npm <span class="nb">install </span>immutable
...
<h2 id="comparison-of-filter-groupby-and-partition">Comparison of filter(), groupBy(), and partition()</h2>

<p>The <code class="language-plaintext highlighter-rouge">filter()</code>, <code class="language-plaintext highlighter-rouge">groupBy()</code>, and <code class="language-plaintext highlighter-rouge">partition()</code> methods are similar in that they
...
(according to <code class="language-plaintext highlighter-rouge">===</code>), even if the contents are identical.</p>

<p>Of these methods, <code class="language-plaintext highlighter-rouge">filter()</code> is the only one that is lazy and the only one which
...
<p>The <code class="language-plaintext highlighter-rouge">partition()</code> method is similar to an eager version of <code class="language-plaintext highlighter-rouge">filter()</code>, but it
returns two collections; the first contains the items that would have been
discarded by <code class="language-plaintext highlighter-rouge">filter()</code>, and the second contains the items that would have been
kept.  It always returns an array of exactly two collections, which can make it
easier to use than <code class="language-plaintext highlighter-rouge">groupBy()</code>.  Compared to making two separate calls to
<code class="language-plaintext highlighter-rouge">filter()</code>, <code class="language-plaintext highlighter-rouge">partition()</code> makes half as many calls it the predicate passed to
it.</p>

<p>The <code class="language-plaintext highlighter-rouge">groupBy()</code> method is a more generalized version of <code class="language-plaintext highlighter-rouge">partition()</code> that can
...
arguments.  Although <code class="language-plaintext highlighter-rouge">groupBy()</code> is more powerful than <code class="language-plaintext highlighter-rouge">partition()</code>, it can be
...
<table>
  <thead>
    <tr>
      ...
      <th style="text-align: left"><code class="language-plaintext highlighter-rouge">filter</code></th>
      <th style="text-align: left"><code class="language-plaintext highlighter-rouge">partition</code></th>
      <th style="text-align: left"><code class="language-plaintext highlighter-rouge">groupBy</code></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td style="text-align: left">hardest</td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="text-align: left">laziness</td>
      <td style="text-align: left">lazy</td>
      <td style="text-align: left">eager</td>
      <td style="text-align: left">eager</td>
    </tr>
    <tr>
      <td style="text-align: left"># of returned sub-collections</td>
      <td style="text-align: left">1</td>
      <td style="text-align: left">2</td>
      <td style="text-align: left">0 or more</td>
    </tr>
    <tr>
      <td style="text-align: left">sub-collections may be empty</td>
      <td style="text-align: left">yes</td>
      <td style="text-align: left">yes</td>
      <td style="text-align: left">no</td>
    </tr>
    <tr>
      <td style="text-align: left">can discard items</td>
      <td style="text-align: left">yes</td>
      <td style="text-align: left">no</td>
      <td style="text-align: left">no</td>
    </tr>
    <tr>
      <td style="text-align: left">wrapping container</td>
      <td style="text-align: left">none</td>
      <td style="text-align: left">array</td>
      <td style="text-align: left">Map/OrderedMap</td>
    </tr>
  </tbody>
</table>
